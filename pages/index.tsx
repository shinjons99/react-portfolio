...
<nav className="p-10 mb-12 flex justify-between">
  ...
  <ul className="flex items-center">
    <li>
      <BsFillMoonStarsFill onClick={() => seDarkMode(!darkMode)} className="cursor-pointer text-2xl dark:text-white" />
    </li>
    <li><a className="bg-gradient-to-r from-cyan-500 text-white px-4 py-2 rounded-md ml-8" href="#">Resume</a></li>
  </ul>
</nav>
<div className="text-center p-10">
  <h2 className="text-5xl py-2 text-teal-600 font-medium md:text-6xl">Md.Afraem Ibne Aziz</h2>
  <h3 className="text-2xl py-2 md:text-3xl dark:text-white">Developer and designer</h3>
  <p className="text-md py-5 leading-8 text-gray-800 md:text-xl max-w-lg mx-auto dark:text-white">Freelancer Providing services for programming and design content
...
<div className="relative mx-auto bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 overflow-hidden md:h-96 md:w-96 dark:bg-white">
...
<section className="py-10">
      ...
      <footer>
        <h3 className="text-teal-600 font-burtons">All Rights Reserved @shinjons99 2023</h3>
      </footer>
    </div>
  )
}
